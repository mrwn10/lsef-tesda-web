$(document).ready(function() {
    ...
    console.log('Student Certificates View initialized');

    // Add click handlers for certificate actions
    $('.view-btn, .download-btn').on('click', function(e) {
        // Optional: Add loading state or tracking
        console.log('Certificate action triggered:', $(this).text().trim());
    });
});